...
*   The module pattern may be appropriate if you wish to create an abstraction that has the ability to do the following:
    _ hide complex implementations
    _ present a simpler interface to the developer than the underlying code
    _ maintain an internal private state
    _ keep variables which are irrelevant to the rest of the code within the private scope of the module
